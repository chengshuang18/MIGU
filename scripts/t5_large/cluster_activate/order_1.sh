...
deepspeed --master_port $port src/run_uie_lora.py \
   --do_train \
   --predict_with_generate \
   --model_name_or_path output/${model}/${method}/${cluster_constructure_method}/order_1/outputs/1-dbpedia/tuning_weight \
   --data_dir CL_Benchmark \
...
deepspeed --master_port $port src/run_uie_lora.py \
   --do_train \
   --predict_with_generate \
   --model_name_or_path output/${model}/${method}/${cluster_constructure_method}/order_1/outputs/2-amazon/tuning_weight \
   --data_dir CL_Benchmark \
...
deepspeed --master_port $port src/run_uie_lora.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path output/${model}/${method}/${cluster_constructure_method}/order_1/outputs/3-yahoo/tuning_weight \
   --data_dir CL_Benchmark \
